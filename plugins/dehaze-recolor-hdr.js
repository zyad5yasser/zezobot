		...
		case "dehaze":
			{
				...
				try {
					...
					conn.sendFile(m.chat, This, "", " https://www.instagram.com/zaidyasser44?igsh=MWkweWpwMG10bjNkeg== ...", m);
				} catch (er) {
					error = true;
				} finally {
					if (error) {
...
handler.help = ["تعديل","تغير-الالوان","جوده"];
handler.tags = ["image-edit"];
handler.command = ["تعديل","تغير-الالوان","جوده"];
